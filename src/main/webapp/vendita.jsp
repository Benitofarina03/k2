...
<meta charset="UTF-8">
    ...
    <script type="text/javascript">
        function sanitizeInput(input) {
            // RegEx per consentire solo caratteri alfanumerici e spazi
            var regex = /^[a-zA-Z0-9\s]+$/;
            return regex.test(input);
        }

        function validateForm() {
            var fields = ["nome", "prezzo", "spedizione", "descrizione"];
            for (var i = 0; i < fields.length; i++) {
                var field = document.forms["productForm"][fields[i]].value;
...
<body>
    ...
    <div class="container" style="height: 540px">
        ...
        <div class="content">
        <form name="productForm" action="Vendita" enctype="multipart/form-data" METHOD="POST" onsubmit="return validateForm()">
